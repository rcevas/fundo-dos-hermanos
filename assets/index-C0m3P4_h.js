(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&o(t)}).observe(document,{childList:!0,subtree:!0});function c(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=c(a);fetch(a.href,i)}})();function n(){const e=document.createElement("nav");return e.classList.add("navbar","navbar-expand-lg","navbar-dark","bg-dark","fixed-top"),e.innerHTML=`
      <div class="container">
  ...
  `,e}function v(){const e=document.createElement("section");return e.setAttribute("id","contacto"),e.classList.add("bg-dark","text-white"),e.innerHTML=`
    <div class="container">      
      <div class="row g-3">
        <div class="col-lg-6 text-center text-lg-start mb-4">
          ...
          <a class="ms-2 text-white" href="tel:+56000000000">+56 000000000</a><br>
          <span><i class="bi bi-envelope-at"></i></span>
          <a class="ms-2 text-white" href="mailto:fundodoshermanos@gmail.com">fundodoshermanos@gmail.com</a>
        </div>
        <div class="col-lg-6">
  ...
  `,e}function b(){const e=document.createElement("footer");return e.classList.add("bg-black","text-light","text-center","p-3"),e.innerHTML=`
    <small>© 2025 Fundo Dos Hermanos. All rights reserved.</small>
  `,e}document.querySelector("#app").append(n(),r(),d(),u(),m(),p(),v(),b());const g=document.querySelectorAll(".navbar-nav .nav-link"),l=document.querySelector(".navbar-collapse");g.forEach(e=>{e.addEventListener("click",()=>{l.classList.contains("show")&&new bootstrap.Collapse(l).hide()})});
